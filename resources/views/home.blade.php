			...
			<form id="myform" class="fs-form fs-form-full" autocomplete="off">
					<ol class="fs-fields">
						...
						<li>
							...
							<div class="wrap">
								<select class="cs-select cs-skin-underline " required>
						...
						<li>
							...
							<div class="fs-radio-group fs-radio-custom clearfix fs-anim-lower">
								<span><input id="q3c" name="q3" type="checkbox" value="social"/><label for="q3c" class="radio-social"><span><img src="sports.png" alt=""></span>Sports</label></span>
